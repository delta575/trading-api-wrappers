...
class Bitfinex(object):
    ...
    def lends(self, currency='btc'): # get a list of the most recent lending data for the given currency: total amount lent and rate (in % by 365 days).
    ...
    def place_order(self, amount, price, side, ord_type, symbol='btcusd', exchange='bitfinex', params=None): # submit a new order.
